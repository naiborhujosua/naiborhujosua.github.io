...
<b><bold>Short Bio.</bold></b> Hello, and welcome to one of my homes on the web! I’m Josua Naiborhu, an independent consultant, machine learning engineer, and a big fan of [Guido van Rossum](https://en.wikipedia.org/wiki/Guido_van_Rossum). I hold a Bachelor of Engineering in Computer Engineering from [Universitas Indonesia](https://www.ui.ac.id/). I can speak in three languages, Indonesian (native), English(C2), and Japanese(N2).
...
<p> Machine Learning Systems by <a href="https://harvard-edge.github.io/cs249r_book/"> Harvard</a></p>
